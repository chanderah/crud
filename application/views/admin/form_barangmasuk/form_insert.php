    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Tambah Data Site ID</li>
        </ol>
      </section>
                      ...
                      <div class="form-group form-group-lg col-md-12">
                        ...
                        <select class="form-control" name="provinsi">
                          ...
                          foreach ($provinsi as $p) {
                            echo '<option value="' . $p->provinsi . '">' . $p->provinsi . '</option>';
                          }
                          ?>
                        </select>
                      </div>
                      <div class="form-group form-group-lg col-md-12">
                        <label for="wilayah" style="display:inline;">Wilayah</label>

                        <input type="radio" name="wilayah" value="Swasta">Swasta</input>
                        <input type="radio" name="wilayah" value="Negeri">Negeri</input>
                      </div>
                      <div class="form-group form-group-lg col-md-12">
